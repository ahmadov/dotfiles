...
-- NOTE: Disabled for performance issue, See: fzf
-- vim.api.nvim_set_keymap("n", "<Leader>ts", [[<Cmd>lua require('telescope').extensions.fzf_writer.grep()<CR>]], opt)
-- vim.api.nvim_set_keymap("n", "<Leader>s", [[<Cmd>lua require('telescope').extensions.fzf_writer.staged_grep()<CR>]], opt)
