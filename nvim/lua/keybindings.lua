...
vim.keymap.set({ '' }, '<leader>cc', '<Cmd>CMakeCloseRunner<CR>', { noremap = true, desc = 'Run CMake configure task' })
vim.keymap.set({ '' }, '<leader>cx', '<Cmd>CMakeClean<CR>', { noremap = true, desc = 'Run CMake clean task' })

vim.keymap.set({ '' }, '<leader>ca', '<Cmd>CMakeSelectBuildTarget<CR>', { noremap = true, desc = 'Select CMake target' })
vim.keymap.set({ '' }, '<leader>ct', '<Cmd>CMakeSelectBuildType<CR>', { noremap = true, desc = 'Select CMake build type' })
vim.keymap.set({ '' }, '<leader>cs', '<Cmd>CMakeSelectLaunchTarget<CR>', { noremap = true, desc = 'Select CMake target' })
vim.keymap.set({ '' }, '<leader>cr', '<Cmd>CMakeRun<CR>', { noremap = true, desc = 'Run CMake target' })
vim.keymap.set({ '' }, '<leader>cd', '<Cmd>CMakeDebug<CR>', { noremap = true, desc = 'Debug CMake target' })
vim.keymap.set({ '' }, '<leader>cb', '<Cmd>CMakeBuild<CR>', { noremap = true, desc = 'Build CMake target' })
